 ...
 */
public class RustEnumStructLiteral extends RustEnumLiteral<Expression> {
	 ...
	 */
	public RustEnumStructLiteral(CFG cfg, CodeLocation location, Expression variableDestructuring, String variantName,
